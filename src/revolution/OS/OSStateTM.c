...
// Old SDK revision: reads and clears the latched reset state, registering the
// STM event handler if it hasn't been registered yet.
...
// BBA debugging stub, referenced from __start.c
