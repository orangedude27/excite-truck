...
// MSL tan() lives in an unnamed MSL translation unit (auto_03_8002B0D8_text).
extern double fn_8002EF30(double x);
...
void C_MTXPerspective(Mtx44 mtx, f32 fovy, f32 aspect, f32 n, f32 f) {
    ...
    rad = 0.5f * fovy;
    rad = 0.017453292f * rad;
    cot = 1.0f / (f32)fn_8002EF30((double)rad);
